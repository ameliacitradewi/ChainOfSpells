...
var enemy2 = EnemyModel( name: "enemy_2", folderName: "enemy_skeleton", idleAnimations:  ["skeleton_1","skeleton_2","skeleton_3","skeleton_4"], hp: 30, initialChainEffect: ChainEffectModel(type: .burn, remainingTurn: 1, level: .enemy), loseImage: "skeleton_1")
...
var enemy4 = EnemyModel( name: "enemy_4", folderName: "enemy_skeleton", idleAnimations:  ["skeleton_1","skeleton_2","skeleton_3","skeleton_4"], hp: 70, initialChainEffect: ChainEffectModel(type: .damageReduction, remainingTurn: 1, level: .enemy), loseImage: "skeleton_1")
...
var enemy6 = EnemyModel( name: "enemy_6", folderName: "enemy_skeleton", idleAnimations:  ["skeleton_1","skeleton_2","skeleton_3","skeleton_4"], hp: 120, initialChainEffect: ChainEffectModel(type: .mist, remainingTurn: 1, level: .enemy), loseImage: "skeleton_1")
